...
class ExplodingEnemy : public Sprite {
public:
  ExplodingEnemy(const Sprite& s);
  ~ExplodingEnemy();
...
private:
  ...
  ExplodingEnemy(const ExplodingEnemy&); // Explicit disallow (Item 6)
  ExplodingEnemy& operator=(const ExplodingEnemy&); // (Item 6)
};
