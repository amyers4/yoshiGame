...
ExplodingEnemy::ExplodingEnemy(const Sprite& s) :
  Sprite(s), 
  chunks(), 
  freeList(){
  makeChunks(
...
void ExplodingEnemy::draw() const { 
...
void ExplodingEnemy::update(Uint32 ticks) { 
...
void ExplodingEnemy::makeChunks(unsigned int n) { 
